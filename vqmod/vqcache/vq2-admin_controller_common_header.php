...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_length_class'] = $this->language->get('text_length_class');
          $this->data['text_compare_prices'] = $this->language->get('text_compare_prices');
		$this->data['text_zone'] = $this->language->get('text_zone');
        $this->data['text_mail'] = 'Wzrorzec wiadomości dla klienta';
        $this->data['text_retailer'] = 'Dostawcy';
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
          ...
          $this->data['compare_prices'] = $this->url->link('extension/compareprices', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['generate_sitemap'] = $this->url->link('tool/generate_sitemap', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['manufacturer_group'] = $this->url->link('catalog/manufacturer_group', 'token=' . $this->session->data['token'], 'SSL');
