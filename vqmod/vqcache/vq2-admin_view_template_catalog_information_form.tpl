        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td>Czy informacja ma być indeksowana w google?</td>
                  <td>
                      <select  name="follow" >
                          <option value="0" <?php if($follow==0){ echo 'selected="selected"'; } ?> >Nie</option>
                          <option value="1" <?php if($follow==1){ echo 'selected="selected"'; } ?> >Tak</option>

                      </select>
                  </td>
              </tr>
              <tr>
                  <td>Wyświetl w górnym menu</td>
                  <td><?php if ($top) { ?>
