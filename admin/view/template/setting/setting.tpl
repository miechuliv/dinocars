      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <tr>
             ...
             <!-- miechu extra fields -->
              ...
              <tr>
                  ...
                  <td><input type="text" name="config_hours" value="<?php echo $config_hours; ?>" /></td>
              </tr> */ ?>
             <?php /* <tr>
                  <td><?php echo $entry_club; ?></td>
                  <td><input type="checkbox" name="config_club" value="1" <?php if($config_club){echo 'checked="'.$config_club.'"';} ?> /></td>
              </tr> */ ?>


             <?php /* <tr>
                  <td><?php echo $entry_text_facebook_check; ?></td>
                  <td><input type="checkbox" name="config_facebook_check" value="1" <?php if($config_facebook_check){echo 'checked="'.$config_facebook_check.'"';} ?>></input></td>
              </tr>
              <tr>
                  <td><?php echo $entry_text_facebook_link; ?></td>
                  <td><input type="text" name="config_facebook_link" value="<?php echo $config_facebook_link; ?>"></input></td>
                  <?php if ($error_facebook_link) { ?>
                  <span class="error"><?php echo $error_facebook_link; ?></span>
                  <?php } ?></td>
              </tr> */ ?>
              <tr>
                  <td><?php echo $entry_text_google_plus; ?></td>
                  <td><input type="text" name="config_google_plus" value="<?php echo $config_google_plus; ?>"></input></td>
              </tr>
            <?php /*  <tr>
                  <td><?php echo $entry_text_twitter; ?></td>
                  <td><input type="text" name="config_twitter" value="<?php echo $config_twitter; ?>"></input></td>
              </tr> */ ?>


            <?php /*  <tr>
                  <td><?php echo $entry_config_price_max; ?></td>
                  <td><input type="text" name="config_price_max" value="<?php echo $config_price_max; ?>"></input></td>
              </tr>
              <tr>
                  <td><?php echo $entry_config_price_step; ?></td>
                  <td><input type="text" name="config_price_step" value="<?php echo $config_price_step; ?>"></input></td>
              </tr>
              <tr>
                  <td><?php echo $entry_delivery_cost; ?></td>
                  <td><input type="text" name="config_delivery_cost" value="<?php echo $config_delivery_cost; ?>"></input></td>
              </tr>
              <tr>
                  <td><?php echo $entry_watermark; ?></td>
                  <td><input type="file" name="config_watermark" value="<?php echo $config_watermark; ?>" /></td>
              </tr> */ ?>
              <!-- miechu extra fileds end  -->
          </table>
        </div>
        <div id="tab-store">
          <table class="form">
       ...
       <?php /* <div id="tab-sms">
            <table>
                <tr>
                    <td>Nazwa nadawcy</td>
                    <td><input type="text" name="config_smsapi_sender" value="<?php echo $config_smsapi_sender; ?>"  /></td>
                </tr>
                <tr>
                    <td>Czy powiadamiać klienta sms-m o przyjęciu zamówienia?</td>
                    <td><input type="checkbox" name="config_smsapi_confirm"  <?php if($config_smsapi_confirm){ echo 'checked="checked"'; }?> /></td>
                </tr>
                <tr>
                    <td>Treść powiadomienia o przyjetym zamówieniu, jesli chcesz aby w treści pojawił się numer zamówienia wpisz dosłownie: {ID} ,<br/> analogicznie słowo {STATUS}
                    oznacza status zamówienia, wartości zostaną automatycznie wypełnione przy wysyłaniu SMS</td>
                    <span class="error"><?php if($error_smsapi_order_confirm_msg){ echo $error_smsapi_order_confirm_msg; }?></span>
                    <td><textarea name="config_smsapi_order_confirm_msg"   ><?php echo $config_smsapi_order_confirm_msg; ?></textarea></td>
                </tr>

                <tr>
                    <td>Czy powiadamiać klienta sms-m o zmianie statusu zamówienia?</td>
                    <td><input type="checkbox" name="config_smsapi_update"  <?php if($config_smsapi_update){ echo 'checked="checked"'; }?> /></td>
                </tr>
                <tr>
                    <td>Treść powiadomienia o zmianie statusu zamówienia jeśli chcesz aby w treści pojawił się numer zamówienia wpisz dosłownie: {ID} ,<br/> analogicznie słowo {STATUS}
                        oznacza status zamówienia, wartości zostaną automatycznie wypełnione przy wysyłaniu SMS. Maksymalna długość wiadomości 160 znaków! </td>
                    <span class="error"><?php if($error_smsapi_order_update_msg){ echo $error_smsapi_order_update_msg; }?></span>
                    <td><textarea  name="config_smsapi_order_update_msg"   ><?php echo $config_smsapi_order_update_msg; ?></textarea></td>
                </tr>
            </table>
        </div> */ ?>
      </form>
