...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $this->data['entry_text_google_plus'] = $this->language->get('entry_google_plus');
        $this->data['entry_text_twitter'] = $this->language->get('entry_twitter');
        $this->data['entry_club'] = $this->language->get('entry_club');
        ...
        $this->data['entry_config_price_max'] = $this->language->get('entry_config_price_max');
        $this->data['entry_config_price_step'] = $this->language->get('entry_config_price_step');

        $this->data['entry_watermark'] = 'Podaj nazwe pliku ze znakiem wodnym';

        $this->data['entry_text_facebook_link']=$this->language->get('entry_text_facebook_link');
        $this->data['entry_text_facebook_check']=$this->language->get('entry_text_facebook_check');
        ...
        if (isset($this->error['error_smsapi_order_update_msg'])) {
            $this->data['error_smsapi_order_update_msg'] = $this->error['error_smsapi_order_update_msg'];
        } else {
            $this->data['error_smsapi_order_update_msg'] = '';
        }

        if (isset($this->error['error_smsapi_order_confirm_msg'])) {
            $this->data['error_smsapi_order_confirm_msg'] = $this->error['error_smsapi_order_confirm_msg'];
        } else {
            $this->data['error_smsapi_order_confirm_msg'] = '';
        }
        ...
        //miechu fields
        if (isset($this->error['facebook_link'])) {
            $this->data['error_facebook_link'] = $this->error['facebook_link'];
        } else {
            $this->data['error_facebook_link'] = '';


        }

        if (isset($this->request->post['config_price_max'])) {
            $this->data['config_price_max'] = $this->request->post['config_price_max'];
        } else {
            $this->data['config_price_max'] = $this->config->get('config_price_max');
        }

        if (isset($this->request->post['config_price_step'])) {
            $this->data['config_price_step'] = $this->request->post['config_price_step'];
        } else {
            $this->data['config_price_step'] = $this->config->get('config_price_step');
        }
        ...
        if (isset($this->request->post['config_hours'])) {
            $this->data['config_hours'] = $this->request->post['config_hours'];
        } else {
            $this->data['config_hours'] = $this->config->get('config_hours');
        }

        if (isset($this->request->post['config_google_plus'])) {
            $this->data['config_google_plus'] = $this->request->post['config_google_plus'];
        } else {
            $this->data['config_google_plus'] = $this->config->get('config_google_plus');
        }
        ...
        if (isset($this->request->post['config_club'])) {
            $this->data['config_club'] = $this->request->post['config_club'];
        } else {
            $this->data['config_club'] = $this->config->get('config_club');
        }

        if (isset($this->request->post['config_facebook_check'])) {
            $this->data['config_facebook_check'] = $this->request->post['config_facebook_check'];
        } else {
            $this->data['config_facebook_check'] = $this->config->get('config_facebook_check');
        }

        if (isset($this->request->post['config_facebook_link'])) {
            $this->data['config_facebook_link'] = $this->request->post['config_facebook_link'];
        } else {
            $this->data['config_facebook_link'] = $this->config->get('config_facebook_link');
        }
        // miechu koniec
        ...
        if (isset($this->request->post['config_delivery_cost'])) {
            $this->data['config_delivery_cost'] = $this->request->post['config_delivery_cost'];
        } else {
            $this->data['config_delivery_cost'] = $this->config->get('config_delivery_cost');
        }
        ...
        if (isset($this->request->post['config_smsapi_sender'])) {
            $this->data['config_smsapi_sender'] = $this->request->post['config_smsapi_sender'];
        } else {
            $this->data['config_smsapi_sender'] = $this->config->get('config_smsapi_sender');
        }

        if (isset($this->request->post['config_smsapi_confirm'])) {
            $this->data['config_smsapi_confirm'] = $this->request->post['config_smsapi_confirm'];
        } else {
            $this->data['config_smsapi_confirm'] = $this->config->get('config_smsapi_confirm');
        }

        if (isset($this->request->post['config_smsapi_order_confirm_msg'])) {
            $this->data['config_smsapi_order_confirm_msg'] = $this->request->post['config_smsapi_order_confirm_msg'];
        } else {
            $this->data['config_smsapi_order_confirm_msg'] = $this->config->get('config_smsapi_order_confirm_msg');
        }

        if (isset($this->request->post['config_smsapi_update'])) {
            $this->data['config_smsapi_update'] = $this->request->post['config_smsapi_update'];
        } else {
            $this->data['config_smsapi_update'] = $this->config->get('config_smsapi_update');
        }

        if (isset($this->request->post['config_smsapi_order_update_msg'])) {
            $this->data['config_smsapi_order_update_msg'] = $this->request->post['config_smsapi_order_update_msg'];
        } else {
