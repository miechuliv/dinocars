...
$_['text_new_customer']              = 'Ich bin noch kein Kunde';
...
$_['text_agree']                     = 'Die <a class="colorbox" href="%s" alt="%s"><b>%s</b></a> habe ich zur Kenntnis genommen und mit iher Geltung bin ich einverstanden.';
...
$_['entry_company_id']               = 'Firmennummer';
...
$_['entry_newsletter']               = 'Ich möchte mich für den %s Newsletter anmelden.';
$_['entry_shipping']                 = 'Meine Liefer- und Rechnungsadresse stimmen überein.';

// Error
$_['error_warning']                  = 'Es ist ein Problem bei der Verarbeitung des Auftrags aufgetreten! Wenn das Problem weiter besteht entweder eine andere Zahlungsart wählen oder die Shopverwaltung <a href="%s">hier</a> kontaktieren.';
...
$_['error_company_id']               = 'Firmennummer ist erforderlich!';
$_['error_tax_id']                   = 'Steuernummer ist erforderlich!';
$_['error_vat']                      = 'Steuernummer ist nicht gültig!';
...
$_['error_agree']                    = 'Es muss den %s Bedingungen zugestimmt werden!';
$_['error_address']                  = 'Es muss eine Adresse ausgewählt werden!';
$_['error_shipping']                 = 'Es muss eine Versandart ausgewählt werden!';
$_['error_no_shipping']              = 'Es sind keine Versandarten verfügbar, für Hilfe bitte uns <a href="%s">kontaktieren</a>.';
$_['error_payment']                  = 'Es muss eine Zahlunsart ausgewählt werden!';
